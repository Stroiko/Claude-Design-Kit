/**
 * text-animate.tsx  (Magic UI effect, MIT - see /CREDITS.md)
 * USE WHEN: Per-word or per-character text reveal on scroll or mount. Hero headlines.
 * INDUSTRY FIT: per DIRECTION.md motion budget only. AVOID FOR: industries whose budget excludes it.
 * PAIRS WITH: hero sections
