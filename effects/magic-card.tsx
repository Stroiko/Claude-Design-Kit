/**
 * magic-card.tsx  (Magic UI effect, MIT - see /CREDITS.md)
 * USE WHEN: Card with a cursor-following spotlight glow. Premium feature or pricing highlights.
 * INDUSTRY FIT: per DIRECTION.md motion budget only. AVOID FOR: industries whose budget excludes it.
 * PAIRS WITH: card, pricing sections
...
export function MagicCard(props: MagicCardProps) {
  ...
  // Dark detection via the .dark class (Tailwind convention) — no next-themes dependency.
